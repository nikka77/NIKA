...
export default function AzurError({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  ...
  return (
    <main style={{ maxWidth: 540, margin: '0 auto', padding: '5rem 1.4rem', textAlign: 'center' }}>
      ...
      <h2 style={{ fontFamily: 'var(--fn)', fontSize: 28, color: 'var(--az)', marginBottom: '0.8rem', letterSpacing: '0.04em' }}>
        ERREUR AZUR
      </h2>
