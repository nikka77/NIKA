// app/riviera/page.tsx — Server Component
// Listing des prestataires Riviera + hero NIKKA Côte d'Azur
import type { Metadata } from 'next'
import { createAdminClient } from '@/lib/supabase/admin'
import ProviderCard from '@/components/riviera/ProviderCard'

export const metadata: Metadata = {
  title: 'NIKKA Riviera — Expériences Côte d\'Azur',
  description: 'Sorties en mer, villas d\'exception, restaurants secrets — prestataires vérifiés par NIKKA sur la Côte d\'Azur.',
}
...
export default async function RivieraPage() {
  ...
  if (supabase) {
    const { data } = await supabase
      ...
      .select('slug,name,category,tagline,location,rating,review_count,verified,packs')
      ...
      <div style={{
        ...
        <div style={{ maxWidth: 1100, margin: '0 auto', position: 'relative' }}>
          ...
          <p style={{
            ...
            chaque prestataire est rencontré et validé par l'équipe NIKKA.
          </p>
        </div>
      </div>
      ...
      <div style={{ maxWidth: 1100, margin: '0 auto', padding: 'clamp(2rem,4vw,3rem) 1.4rem' }}>
        <div style={{ marginBottom: '2rem' }}>
          ...
          <p style={{ fontFamily: 'var(--fo)', fontSize: 13, color: 'var(--td3)', marginTop: '0.5rem' }}>
            Sélection manuelle · Chaque prestataire est rencontré et vérifié par l'équipe NIKKA
          </p>
        </div>
