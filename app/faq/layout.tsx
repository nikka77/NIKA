// app/faq/layout.tsx — métadonnées de la page (23/08/2026).
//
...
export const metadata: Metadata = {
  title: 'FAQ — NIKA',
  description: 'Les réponses aux questions fréquentes sur NIKA : commandes, VTC, logements, paiement, compte, NIKO.',
  alternates: { canonical: `${SITE_URL}${chemin}` },
  openGraph: { title: 'FAQ — NIKA', description: 'Les réponses aux questions fréquentes sur NIKA : commandes, VTC, logements, paiement, compte, NIKO.', url: `${SITE_URL}${chemin}`, type: 'website', locale: 'fr_FR' },
};
