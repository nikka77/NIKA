-- NIKA — Migration de rattrapage (tables manquantes en base live).
-- Idempotent (IF NOT EXISTS / DROP POLICY IF EXISTS). À coller en UNE fois dans Supabase → SQL Editor → Run.
-- Crée : contact_messages, reviews, news_comments, sms_logs, stay_issues, stay_stats, devis, devis_lignes.
-- =====================================================================
