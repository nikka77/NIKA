...
const CHARACTERS = [
  ...
  { key: 'Sasuke Uchiha', village: 'konohagakure', clan: 'uchiha', powers: ['chidori', 'amaterasu', 'susanoo'], skills: ['sharingan', 'rinnegan'], artifacts: ['kusanagi'], rarity: 'legendary',
    ...
    forms: [
      { label: 'Partie I', g: 0, age: '12 ans', height: '1,50 m', weight: '42 kg', rank: 'Genin',
      ...
      { label: 'Sceau maudit', img: '/images/akasha/naruto/sasuke-cs2.webp', age: '13 ans', height: '1,53 m', weight: '43 kg', rank: 'Genin',
      ...
      { label: 'Hebi', g: 1, age: '16 ans', height: '1,68 m', weight: '52 kg', rank: 'Déserteur',
      ...
      { label: 'Mangekyō éternel', img: '/images/akasha/naruto/sasuke-susanoo.webp', age: '17 ans', height: '1,68 m', weight: '52 kg', rank: 'Déserteur',
      ...
      { label: 'Rinnegan', img: '/images/akasha/naruto/sasuke-adulte.webp', age: '19 ans+', height: '1,82 m', weight: '56 kg', rank: 'Nukenin gracié',
  ...
  { key: 'Kakashi Hatake', village: 'konohagakure', clan: 'hatake', ranks: ['hokage'], powers: ['chidori'], skills: ['sharingan'], rarity: 'epic',
    ...
    forms: [
      { label: 'Anbu', img: '/images/akasha/naruto/kakashi-anbu.webp', age: '14-20 ans', height: '1,68 m', rank: 'Anbu',
      ...
      { label: 'Ninja copieur', g: 0, age: '26-27 ans', height: '1,81 m', weight: '67,5 kg', rank: 'Jōnin',
      ...
      { label: 'Kamui', img: '/images/akasha/naruto/kakashi-kamui.webp', age: '29-31 ans', height: '1,81 m', rank: 'Jōnin',
        ...
        stats: { nin: 5, tai: 4.5, gen: 4, int: 5, for: 3.5, vit: 4.5, end: 3, sce: 5 } },
      { label: 'Double Mangekyō', img: '/images/akasha/naruto/kakashi-guerre.webp', age: '31 ans', height: '1,81 m', rank: 'Jōnin',
      ...
      { label: 'Hokage', img: '/images/akasha/naruto/kakashi-hokage.webp', age: '32+ ans', height: '1,81 m', rank: 'Hokage',
  ...
  { key: 'Itachi Uchiha', village: 'konohagakure', clan: 'uchiha', powers: ['amaterasu', 'susanoo'], skills: ['sharingan'], rarity: 'epic',
    ...
    forms: [
      { label: 'Anbu', img: '/images/akasha/naruto/itachi-anbu.webp', age: '11-13 ans', height: '1,60 m', rank: 'Capitaine Anbu',
      ...
      { label: 'Akatsuki', g: 0, age: '17-21 ans', height: '1,78 m', weight: '58 kg', rank: 'Nukenin (rang S)',
      ...
      { label: 'Susanoo', img: '/images/akasha/naruto/itachi-susanoo.webp', age: '21 ans', height: '1,78 m', rank: 'Nukenin (rang S)',
      ...
      { label: 'Edo Tensei', img: '/images/akasha/naruto/itachi-edo.webp', age: '—', height: '1,78 m', rank: 'Réanimé',
  ...
  { key: 'Madara Uchiha', village: 'konohagakure', clan: 'uchiha', powers: ['susanoo', 'wood-release'], skills: ['sharingan', 'rinnegan'], artifacts: ['gunbai'], rarity: 'legendary',
    ...
    forms: [
      { label: 'Guerres claniques', img: '/images/akasha/naruto/madara-fondateur.webp', age: 'Jeunesse', height: '1,79 m', weight: '71 kg', rank: 'Chef de clan',
      ...
      { label: 'Fondation', g: 0, age: 'Adulte', height: '1,79 m', weight: '71 kg', rank: 'Cofondateur',
      ...
      { label: 'Edo Tensei', img: '/images/akasha/naruto/madara-susanoo.webp', age: '—', height: '1,79 m', rank: 'Réanimé (rang S+)',
      ...
      { label: 'Jinchūriki du Jūbi', img: '/images/akasha/naruto/madara-juubi.webp', age: '—', height: '1,79 m', rank: 'Jinchūriki du Jūbi',
  ...
  { key: 'Hashirama Senju', village: 'konohagakure', clan: 'senju', ranks: ['hokage'], powers: ['wood-release'], rarity: 'legendary',
    ...
    forms: [
      { label: 'Ère des clans', g: 0, age: 'Jeunesse', height: '1,85 m', weight: '74 kg', rank: 'Chef de clan',
      ...
      { label: 'Premier Hokage', img: '/images/akasha/naruto/hashirama-hokage.webp', age: 'Adulte', height: '1,85 m', weight: '74 kg', rank: 'Hokage',
        ...
        stats: { nin: 5, tai: 4.5, gen: 3.5, int: 4.5, for: 5, vit: 4.5, end: 5, sce: 5 } },
      { label: 'Mode Ermite', img: '/images/akasha/naruto/hashirama-sage.webp', age: 'Adulte', height: '1,85 m', rank: 'Hokage',
      ...
      { label: 'Vallée de la Fin', img: '/images/akasha/naruto/hashirama-vallee.webp', age: 'Adulte', height: '1,85 m', rank: 'Hokage',
...
const BEASTS = [
  { key: 'Kurama', slug: 'kurama', rarity: 'legendary', summary: "Le Démon-renard à Neuf Queues, le plus puissant des Bijū, scellé en Naruto.",
    ...
    forms: [
      { label: 'Le Fléau', img: '/images/akasha/naruto/kurama-rage.webp', age: 'Immémorial', height: '≈ 100 m', rank: 'Bijū (9 queues)',
      ...
      { label: 'La Cage', img: '/images/akasha/naruto/kurama-cage.webp', age: 'Immémorial', height: '≈ 100 m', rank: 'Bijū scellé',
      ...
      { label: 'Chakra doré', img: '/images/akasha/naruto/kurama-doree.webp', age: 'Immémorial', height: '≈ 100 m', rank: 'Partenaire',
  ...
  for (const c of CHARACTERS) {
    ...
    const attributes = purge({
      ...
      forms: (c.forms || []).map((f) => ({
        ...
        // ⚠ IDLE_SLUG est indexée par LABEL de forme (« Hokage », « Partie I »…) : réservée à Naruto,
        // sinon les formes homonymes des autres persos héritent de SES sprites pixel.
        idle: c.key === 'Naruto Uzumaki' && IDLE_SLUG[f.label] ? `/images/akasha/naruto/idle/${IDLE_SLUG[f.label]}.webp` : undefined,
